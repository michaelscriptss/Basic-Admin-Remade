...
['Super Admins'] = {
	...
	['Server Message'] = ('Frappuccino Systems'), -- Displayed in the :sm command's title.
	['Server Lock Reason'] = ('Frappuccino | The server is locked.'), -- Displayed to people being kicked that try to enter a locked server.
	...
	['Datastore Key'] = ('FRAPPUCCINO_ADMIN') -- What cape data, ban data, etc. is stored under. Changing will wipe it.
